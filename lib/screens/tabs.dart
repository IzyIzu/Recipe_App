...
import 'package:recipe_app/providers/filters_provider.dart';
...
class _TabsScreenState extends ConsumerState<TabsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var activePageTitle = 'Recipe Categories';
    ...
    if (_selectedPageIndex == 1) {
      ...
      activePageTitle = 'Favorite Recipe';
    }
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.set_meal), label: 'Recipe Category'),
